...
class ParksControllerTest < ActionController::TestCase
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post :create, park: { field_option: @park.field_option, max: @park.max, min: @park.min, stadium_id: @park.stadium_id }
    end
  ...
  test "should update park" do
    patch :update, id: @park, park: { field_option: @park.field_option, max: @park.max, min: @park.min, stadium_id: @park.stadium_id }
    assert_redirected_to park_path(assigns(:park))
  end
