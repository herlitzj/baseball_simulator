...
class PlaysControllerTest < ActionController::TestCase
  ...
  test "should create play" do
    assert_difference('Play.count') do
      post :create, play: { fatigue: @play.fatigue, field: @play.field, max: @play.max, min: @play.min, play: @play.play, player_id: @play.player_id, vs_hand: @play.vs_hand }
    end
  ...
  test "should update play" do
    patch :update, id: @play, play: { fatigue: @play.fatigue, field: @play.field, max: @play.max, min: @play.min, play: @play.play, player_id: @play.player_id, vs_hand: @play.vs_hand }
    assert_redirected_to play_path(assigns(:play))
  end
