...
class TemperaturesControllerTest < ActionController::TestCase
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post :create, temperature: { location_id: @temperature.location_id, max: @temperature.max, min: @temperature.min, month: @temperature.month, temp: @temperature.temp, time: @temperature.time }
    end
  ...
  test "should update temperature" do
    patch :update, id: @temperature, temperature: { location_id: @temperature.location_id, max: @temperature.max, min: @temperature.min, month: @temperature.month, temp: @temperature.temp, time: @temperature.time }
    assert_redirected_to temperature_path(assigns(:temperature))
  end
